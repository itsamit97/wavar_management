    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <img src="{{asset('admin_assets/img/title.jpg')}}"
                    style="height:52px; border-radius:50%; width:60px;">
                <!-- <div class="sidebar-brand-text mx-3">educationCommittee </div> -->
                managment
            </a>
            <!-- Divider -->
            ...
            <hr class="sidebar-divider">
            <li class="nav-item">
                <a class="nav-link collapsed" href="shop-branch">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Branch Lists</span>
                </a>
            </li>
            <hr class="sidebar-divider">

            <li class="nav-item">
                <a class="nav-link collapsed" href="view-branch-bills">
                    <i class="fas fa-fw fa-folder"></i>
